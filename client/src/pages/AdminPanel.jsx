                        ...
                        <div className="flex items-center gap-6 w-full md:w-auto">
                           ...
                           <div className="flex-grow">
                              <div className="flex items-center gap-2 mb-1">
                                 <span className={`text-[8px] font-black px-1.5 py-0.5 rounded uppercase tracking-widest ring-1 ring-inset ${
                                    event.status === 'PUBLISHED' ? 'bg-emerald-500/10 text-emerald-500 ring-emerald-500/20' : 
                              ...
                              <p className="text-xs text-slate-500 font-bold uppercase flex items-center gap-1">
                                 <Users size={12} className="text-red-600" /> {event.organizer?.name} • <Mail size={12} /> {event.organizer?.email}
                              </p>
                           </div>
                        </div>
